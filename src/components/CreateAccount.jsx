            ...
            <form onSubmit={handleSubmit} className="row g-3 mb-4 px-4">
                ...
                <div className="d-flex gap-3">
                  <div
                    ...
                    style={{
                      ...
                      background:
                        accountType === "student" ? "#fdf5ef" : "#fff",
                      transition: "all 0.2s",
                    }}
                  >
                    <i
                      className="fa-solid fa-user-graduate fa-lg mb-2"
                      style={{
                        color:
                          accountType === "student" ? "#633a19" : "#6c757d",
                      }}
                    />
                    <div
                  ...
                  >
                    <i
                      className="fa-solid fa-chalkboard-user fa-lg mb-2"
                      style={{
                        color: accountType === "doctor" ? "#633a19" : "#6c757d",
                      }}
                    />
                    <div
                      className="fw-bold small"
              ...
              <div className="col-md-12">
                <label htmlFor="studentid" className="form-label colorgray">
                  {accountType === "doctor" ? "Doctor ID" : "Student ID"}
                </label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="col-md-12 mb-4 position-relative">
                ...
                {showConfirmInvalid && (
                  <div className="invalid-feedback mt-2 fs-6">
                    Passwords do not match.
                  </div>
                )}
                {showConfirmValid && (
                  <div className="valid-feedback mt-2 fs-6">
                    Passwords match.
                  </div>
                )}
              </div>
