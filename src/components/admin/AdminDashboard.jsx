            ...
            >
              <div
                style={{
                  ...
                  background:
                    pct > 0
                      ? "linear-gradient(180deg, #9e734a, #633a19)"
                      : "#f3f4f6",
...
export default function AdminDashboard() {
  ...
  const borrowedBooks = books.filter(
    (b) => b.status === "borrowed" || b.status === "Borrowed",
  ).length;
  ...
  const overdueLoans = loans.filter(
    (l) => l.status === "Overdue" || l.status === "overdue",
  ).length;
  ...
  const donutSegments = catEntries.map(([name, value], i) => ({
    name,
    value,
  ...
  loans.forEach((l) => {
    if (l.bookId || l.bookTitle) {
      ...
      bookBorrowCount[key] = {
        count: (bookBorrowCount[key]?.count || 0) + 1,
        title: l.bookTitle || l.bookId,
      };
    }
  });
  const topBooks = Object.values(bookBorrowCount)
    ...
    <div style={{ minHeight: "100vh", background: "#f9f6f2", paddingTop: 70 }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        ...
        >
          ...
          {pendingRequests > 0 && (
            <button
              onClick={() => navigate("/admin/FacultyRequests")}
              style={{
                background: "#633a19",
                color: "#fff",
                border: "none",
        ...
        >
          ...
          <StatCard
            ...
            label="Active Loans"
            value={activeLoans}
            sub={overdueLoans > 0 ? `⚠ ${overdueLoans} overdue` : "All on time"}
            subColor={overdueLoans > 0 ? "#ef4444" : "#16a34a"}
            loading={loading}
          />
          <StatCard
            icon="📖"
        ...
        >
          ...
          >
            ...
            >
              <div>
                <div
                  style={{ fontWeight: 800, fontSize: 17, color: "#1f2937" }}
                >
                  Weekly Borrowing Activity
                </div>
                <div style={{ fontSize: 13, color: "#9ca3af", marginTop: 2 }}>
                  Loans registered this week
                </div>
              </div>
              <span
                style={{
                  background: "rgba(99,58,25,0.08)",
                  color: "#633a19",
                  fontSize: 12,
                  fontWeight: 700,
                  padding: "4px 10px",
        ...
        >
              ...
              topBooks.map((b, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "12px 0",
                    borderBottom:
                      i < topBooks.length - 1 ? "1px solid #f5f5f5" : "none",
                  }}
                >
                  <div
                    style={{
                      ...
                      height: 52,
                      borderRadius: 6,
                      background: `linear-gradient(135deg, ${catColors[i]}, ${catColors[(i + 1) % catColors.length]})`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => navigate("/admin/BorrowingLog")}
                style={{
                  background: "rgba(99,58,25,0.08)",
                  color: "#633a19",
                  border: "none",
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 12, color: "#9ca3af" }}>
                        {loan.userName || loan.userId?.slice(0, 8) || "—"}
                      </div>
                    </div>
                    <span
                      style={{
          ...
          >
            {[
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#633a19";
                  e.currentTarget.style.color = "#fff";
                  e.currentTarget.style.borderColor = "#633a19";
                }}
                onMouseLeave={(e) => {
