        ...
        <div className="col-md-4 p-3 form  border rounded-4  shadow">
          <div className="col-md-12">
            <div className="text-center my-5">
              <h3 className="darkorange fw-bolder px-4 mt-5">
                Reset Your Password
              </h3>
              <p className=" px-4">
                Enter your institutional email and we will send you a secure
            ...
            <div className="border-top m-4 p-3 text-center d-flex align-items-baseline justify-content-center">
              <Link
                to="/"
